...
#define Write_Display_reg 0b01000100
#define Read_Key_reg      0b01000110
...
void setup() {
  ...
  shiftOut(TM1638_DIO, TM1638_CLK, LSBFIRST, 0b10001100);
  digitalWrite(TM1638_STB, HIGH);
}
 ...
 */
  sendData(Set_Reg_addr + led + 1, stat & 0b00000001);
}
 ...
 */
  ...
  Serial.print("(dat & 0b10000000) >> 7 = ");
  Serial.println((dat & 0b10000000) >> 7);
  Serial.print("(dat & 0b01000000) >> 6 = ");
  Serial.println((dat & 0b01000000) >> 6);
  Serial.print("(dat & 0b00100000) >> 5 = ");
  Serial.println((dat & 0b00100000) >> 5);
  Serial.print("(dat & 0b00010000) >> 4 = ");
  Serial.println((dat & 0b00010000) >> 4);
  Serial.print("(dat & 0b00001000) >> 3 = ");
  Serial.println((dat & 0b00001000) >> 3);
  Serial.print("(dat & 0b00000100) >> 2 = ");
  Serial.println((dat & 0b00000100) >> 2);
  Serial.print("(dat & 0b00000010) >> 1 = ");
  Serial.println((dat & 0b00000010) >> 1);
  Serial.print("(dat & 0b00000001) >> 0 = ");
  Serial.println((dat & 0b00000001) >> 0);
  Serial.println();
}
